...
<img class="aligncenter wp-image-163 " src="{{ site.url }}/images/2014/10/IMG_0108-575x1024.png" alt="message highlighting" width="375" height="668" />
...
<img class="aligncenter size-full wp-image-164" src="{{ site.url }}/images/2014/10/emailios8.png" alt="emailios8" width="750" height="313" srcset="{{ site.url }}/images/2014/10/emailios8-300x125.png 300w, {{ site.url }}/images/2014/10/emailios8.png 750w" sizes="(max-width: 750px) 100vw, 750px" />
...
<img class="aligncenter wp-image-158" src="{{ site.url }}/images/2014/10/IMG_0063.png" alt="QuickType word suggestions" width="375" height="668" />

This is definitely a long-term time saver, so let me explain. When you use a <a href="http://www.imore.com/how-use-quicktype-keyboard-ios-8" target="_blank">QuickType suggestion</a> on the iOS 8 keyboard, it always adds a space after the word. This is nice until you want to end the sentence, right? Well, it still is nice because if you were to type a sentence-ending punctuation like a question mark or exclamation point, it appends it onto the end of the word and not a space in front of it.

### 4. The difference between &#8216;Send My Current Location&#8217; and &#8216;Share My Location&#8217;

<img class="aligncenter wp-image-162" src="{{ site.url }}/images/2014/10/IMG_0107.png" alt="sharing location ios8" width="375" height="667" />
...
<img class="aligncenter  wp-image-173" src="{{ site.url }}/images/2014/10/medID.png" alt="medID" width="662" height="589" srcset="{{ site.url }}/images/2014/10/medID-1200x1066.png 1200w, {{ site.url }}/images/2014/10/medID.png 1508w" sizes="(max-width: 662px) 100vw, 662px" />
